...
import org.example.entities.Insurance;
...
public class InsuranceDao<T extends Insurance, F extends Filter> extends AbstractDao<T>{
    public InsuranceDao(Class<T> entityType) {
        super(entityType);
    }
